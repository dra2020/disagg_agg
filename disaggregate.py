...
def filter_prop_key(cand_code, state, source_year, listpropsonly=False):
    ...
    if source_year == 2008:
        ...
        if cand_code[0:6] == "G22HOR":
            contest = "G" + (str(source_year)[2:4]) + "CON" + ("DVAR" if cand_code[6:9] == "DEM" else "RVAR" if cand_code[6:9] == "REP" else "IOTH")
        return contest
          ...
          state == "OK" or state == "NH" or state == "MD" or state == "NC" or state == "MO" or state == "UT" or state == "IN" or state == "VA" or state == "NE"):
